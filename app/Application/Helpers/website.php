...
function  getSubscriptionPrices()
{
    ...
    $data['subscription_monthly'] = round($homeSettings->MonthlyB2cSubscriptionPrice);
    $data['subscription_yearly'] = round($homeSettings->subscription_yearly * $exchangeRate);
    $data['subscription_yearly_after'] = round($homeSettings->YearlyB2cSubscriptionPrice);
    $data['subscription_yearly_before'] = round(($homeSettings->MonthlyB2cSubscriptionPrice * 12));
