...
<head>
   ...
   <title>Training FutureWork</title>
   <!-- CSS Reset : BEGIN -->
   <style>
                     ...
                     <tr align="center" valign="center" style="border: 1px solid #ddd; border-top: 0; background: #fff;">
                        <td style="background-color: #fff">
                           <a href="#" target="_blank" style="display: block; width: 100%; padding-bottom: 40px; padding-top: 40px;">
                              <img src="https://training.futurework.com.sa/subscription-new/src/images/FuturWorkLogoDark.png" alt="IGTS" style="width: 170px;">
                           </a>
                        </td>
                     </tr>
                     ...
                     <tr>
                        <td style="text-align: center;">
                           <p style=" margin: 0; padding-top: 10px; padding-bottom: 20px; color: #BEBEBE;">
                              ...
                              <br>
                              © 2025 <a href="https://training.futurework.com.sa" style="text-decoration: underline;">Futurework</a>. All rights reserved.                                  </p>
                        </td>
                     </tr>
                     <tr style="height: 15px;">
                        <td></td>
