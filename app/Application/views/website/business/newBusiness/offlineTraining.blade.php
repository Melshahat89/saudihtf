                        ...
                        >
                            <div class="flex items-center justify-start gap-4">
                                <div
                                    ...
                                    <img src="{{ asset('business/newBusiness') }}/src/images/inner-feat-01.svg"
                                            alt="check"
                                            class="w-[38px] h-[38px]"/>
                                </div>
                                <h3
            ...
            <div class="flex flex-col-reverse gap-10 md:flex-row">
                <div class="flex justify-center flex-col md:w-[60%]">
                    ...
                    <a href="{{url('business/offer-price')}}"
                            class="h-[42px] inline-block text-center w-[160px] mt-[35px] leading-[19px] px-4 py-2 text-white rounded-full bg-secondary transition ease-in-out hover:bg-offlineTrainingTheme-primary"
