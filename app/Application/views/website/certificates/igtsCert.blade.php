...
<div class="content">
    ...
    <style>
        ...
        {{--@font-face {--}}
        {{--    font-family: 'Cairo';--}}
        {{--    src: url('{{ resource_path('fonts/Cairo/static/Cairo-Regular.ttf') }}') format('truetype');--}}
        {{--}--}}
        body {
    ...
    .content {
        ...
        width:100%;
        height:100%;
        background:transparent url('https://training.futurework.com.sa/website/images/certificate.jpg') no-repeat 0 0;
    ...
    <div class="content_text">
        ...
        <p style="font-family: 'Cairo'; text-transform:uppercase;font-size: 24px; font-weight: 700;color: #6c6c67;position: absolute; right: 0; left: 0; top: 520px;">
