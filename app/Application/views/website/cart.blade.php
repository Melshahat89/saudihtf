                                    ...
                                    <?php if($cartItem->type == Ordersposition::TYPE_Course){?>
                                        ...
                                        <div class="course_card_item row pt-2 pb-2">
                                            ...
                                            <div class="col-7 align-self-center">
                                                ...
                                                <div class="d-flex pt-2 align-self-center">
                                                    <div class="jq_rating jq-stars d-none" data-options='{"initialRating":{{round($cartItem->courses->CourseRating, 1)}}, "readOnly":true, "starSize":17}'></div>
                                                    <div class="text_muted d-none">{{round($cartItem->courses->CourseRating, 1)}}</div>
                                                </div>
                                            </div>
