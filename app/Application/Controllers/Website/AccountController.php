...
class AccountController extends AbstractController
{
    ...
    protected $middleware;
     ...
     public function edit(){
        ...
        $this->data['categories'] = Categories::orderBy('id','desc')->get()->pluck('name_lang', 'id')->toArray();
...
//        $request->request->add(['usersCoursesEnrollments'=> Auth::user()->usersCoursesEnrollments]) ;
         ...
         $enrollments = Auth::user()->usersCoursesEnrollments->pluck('id')->toArray();
         $request->request->add(['usersCoursesEnrollments' => $enrollments]);
